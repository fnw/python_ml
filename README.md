...
**Update 19/05/2026** Adopted modern Python project conventions, with pyproject.toml. I now recommend UV for dependencies management. Most of the tests are now working, except the ones that relied on deprecated datasets.
